...
async def start(client, message):
    ...
    loading_sticker_message = await message.reply_sticker("CAACAgIAAxkBAAEPEVZoj1OD-riB46j_KaUh6-TnhwE95QAChBEAAo7muUsk7jGIPQwU0DYE")
    ...
    button = InlineKeyboardMarkup([
        [InlineKeyboardButton("📢 Updates", url="https://telegram.me/Dramafilez"),
        InlineKeyboardButton("💬 Support", url="https://telegram.me/k_drama_fans_chat_group")],
        [InlineKeyboardButton("🛠️ Help", callback_data='help'),
        InlineKeyboardButton("❤️‍🩹 About", callback_data='about')],
        [InlineKeyboardButton("🧑‍💻 Developer 🧑‍💻", url="https://telegram.me/Dramafilez")]
        ])
